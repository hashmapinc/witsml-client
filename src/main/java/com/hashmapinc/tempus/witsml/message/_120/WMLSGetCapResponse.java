 ...
 *       <sequence>
 *         <element name="CapabilitiesOut" type="{http://www.w3.org/2001/XMLSchema}string" form="unqualified"/>
...
public class WMLSGetCapResponse {
    ...
    @XmlElement(name = "CapabilitiesOut", required = true, nillable = true)
    protected String capabilitiesOut;
    ...
    /**
     * Gets the value of the capabilitiesOut property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the capabilitiesOut property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setCapabilitiesOut(String value) {
